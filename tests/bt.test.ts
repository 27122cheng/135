...
const r1 = backtestPlanGeometry("long", 100, 99, 102, up, 2)!;
...
const r2 = backtestPlanGeometry("short", 100, 101, 98, up, 2)!;
...
const r3 = backtestPlanGeometry("long", 100, 95, 105, flat, 2)!;
...
const r4 = backtestPlanGeometry("long", 100, 98, 102, wide, 2)!;
...
check("insufficient data must return null", backtestPlanGeometry("long", 100, 99, 102, bars([100, 101, 102]), 2) === null);
