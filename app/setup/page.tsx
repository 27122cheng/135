    ...
    <main className="mx-auto max-w-2xl px-4 py-5">
      ...
      <div className="flex flex-col gap-3">
        ...
        <Step n={6} title="打開排程（選填）">
          ...
          <p className="text-amber-500/80">
            實測（最近 30 次排程）：兩個排程 GitHub 都會降級，而且比先前估計的嚴重得多 ——
            掃描要求每小時，實際中位數 2.9 小時、最長 12.6 小時；監控要求每 5 分鐘，
            實際中位數 3.5 小時、最長 12.3 小時。監控已改成每次用「自上次檢查以來的 H4 高低區間」
            補判進場／停損／停利，所以中間發生的事不會再漏掉，只是會晚幾小時才通知。
            想要真的即時，去{" "}
            <a
